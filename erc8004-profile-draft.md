...
- communication/social_media_management
...
### Added:
- "Operated by 0xdas" (transparency)
...
### Updated:
- Description is service-oriented, not narrative
- Skills reflect operational capabilities
- Domains align with actual work areas

---

## Implementation Notes

- Current registration uses data URI (onchain storage)
- This draft designed for HTTP or data URI deployment
- No external dependencies on IPFS/Pinata
- Estimated gas cost: ~$0.10-0.50 on Base
