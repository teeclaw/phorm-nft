...
KEYS = [
    ...
    "AGENTMANIFESTO_USERNAME", "AGENTMANIFESTO_ACCESS_TOKEN", "AGENTMANIFESTO_ACCESS_TOKEN_SECRET", "AGENTMANIFESTO_API_KEY", "AGENTMANIFESTO_API_KEY_SECRET", "AGENTMANIFESTO_BEARER_TOKEN", "AGENTMANIFESTO_CLIENT_SECRET_ID", "AGENTMANIFESTO_CLIENT_SECRET", "AGENTMANIFESTO_FARCASTER_WALLET_ADDRESS", "AGENTMANIFESTO_FARCASTER_PRIVATE_KEY", "AGENTMANIFESTO_FARCASTER_FID", "AGENTMANIFESTO_FARCASTER_FNAME", "AGENTMANIFESTO_FARCASTER_CUSTODY_ADDRESS", "AGENTMANIFESTO_FARCASTER_SIGNER_PUBLIC_KEY", "AGENTMANIFESTO_FARCASTER_SIGNER_PRIVATE_KEY",
